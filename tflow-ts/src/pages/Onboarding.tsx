        ...
        <div className="w-full bg-secondary">
            ...
            <div id="body" className="p-8 flex flex-col space-y-7">
                <div className="flex flex-col space-y-2">
                    ...
                    <p className="text-sm">
                        Boost productivity with TabFlow: effortlessly track,
                        organize, and clean up tabs for a seamless browsing
                        experience.
                    </p>
                </div>
                <div className="border border-primary flex flex-col space-y-3 p-6 items-center rounded-lg">
                    ...
                    <ul className="list-disc space-y-3 w-9/12">
                        ...
                        <li className="text-sm">
                            Adjust tab management preferences and notifications
                            in the Settings.
                        </li>
                        <li className="text-sm">
                            And Tada! Let TabFlow organize your tabs for a
                ...
                <div className="flex flex-col items-center justify-center space-y-3">
                    <p className="text-sm">
                        Click the button below to get running
                    </p>
